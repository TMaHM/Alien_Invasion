...
def check_envents(ai_settings, screen, stats, play_button, ship,
                  aliens, bullets):
    """响应按键和鼠标事件"""
...
def update_bullets(ai_settings, screen, ship, aliens, bullets):
    ...
    # print(len(bullets)) # 用来测试子弹数量的限制是否生效
...
def create_alien(ai_settings, screen, aliens, alien_numer, row_number):
    """创建一个外星人并将其放在当前行"""
